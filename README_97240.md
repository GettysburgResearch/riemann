...
It does **not** claim a proof of the Riemann Hypothesis. It closes the following
...
The remaining arithmetic producer is `GABPT`, the Global Activation-Boundary
Parity Transport theorem. `GABPT -> RH` is proved conditionally.
