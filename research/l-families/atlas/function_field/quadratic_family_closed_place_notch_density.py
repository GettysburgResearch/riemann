...
def build_payload() -> dict[str, object]:
    ...
    payload: dict[str, object] = {
        ...
        "rigorous_fixed_q_asymptotic": {
            ...
            "literature_boundary": "The general rough-polynomial Buchstab law is standard; see Panario--Richmond, Analysis of Ben-Or's polynomial irreducibility test, Random Structures & Algorithms 13 (1998), 439--456, DOI 10.1002/(SICI)1098-2418(199810/12)13:3/4<439::AID-RSA13>3.0.CO;2-U.",
        ...
        "claim_boundary": [
            ...
            "The fixed-q asymptotic is a standard rough-polynomial/Buchstab law, also derived here from the at-most-three-factor decomposition; it is not inferred from the finite table and no novelty is claimed for it.",
