...
Thus a termwise hook expansion has canonical absolute rank masses obtained
by multiplying (4.3) by \(48,32,16\), respectively.  The selector no-go
proves that no other exact full-\(S_a\times S_b\), characteristic-zero
semisimple presentation reduces (4.3).  It does **not** rule out cancellation
after tensoring with the complete FFPS source complex, and this packet does
not claim a lower bound for every such joint complex.
