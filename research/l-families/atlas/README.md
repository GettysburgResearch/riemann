...
|---|---|---|---|
| [generalized local coefficient powers](generalized/README.md) | exact recurrence, Laurent, and Fourier algebra | in the hyperbolic positive branch, complex coefficient powers are rational exactly at nonnegative integers; on an irrational tempered orbit, absolute powers are rational exactly at even nonnegative integers, with minimal order \(2m+1\) | two narrow local Gate-0 verdicts; no global Euler product, automorphic nonintegral symmetric power, novelty, or zero claim |
