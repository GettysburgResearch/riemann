# Research: results, proofs and active work

The [cumulative results catalogue](../RESULTS.md) explains what the project has achieved. [Current statements and proof routes](integrated/CURRENT_RESULTS.md) supplies hypotheses, corrected formulations and links to the full arguments. The [extended research index](RESULTS_INDEX.md) preserves both resident packets and earlier source-qualified results.
