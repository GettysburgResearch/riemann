...
2. For a hypothetical left-half zero, the modulus `|phi_alpha(rho)|` can be
   amplified by placing the center near its ordinate and horizontal displacement.
...
```text
|1-1/rho| = 1 + delta/|rho|^2 + O(delta^2/|rho|^4),
```
