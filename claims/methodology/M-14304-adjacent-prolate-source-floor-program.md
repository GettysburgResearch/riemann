# M-14304 — Exact adjacent-prolate source and lower-floor program
...
Dependencies: L-14308 through L-14315; T-14302 and T-14304  
...
Use `L-14315` to report the numerator as the exact weighted dual norm
...
The alternative `T-14304` route may be run on the same source packet: projective
convergence of simple-even ground transforms to any nonzero zeta-factor target
also suffices.

## Exact checker

`X-14308` verifies the finite algebra independent of prolate numerics:
