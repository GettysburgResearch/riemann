# L-9701 — Total-count-saturated Hardy-​Z sign chains isolate every zero
...
This claim was initially drafted as `L-9306`.  Concurrent PR #103 had already
allocated that identifier.  The mathematical content is unchanged; `L-9701` is
the stable identifier for this branch.
