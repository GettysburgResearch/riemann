# L-91695 — Adaptive one-use thinning proves the `10152 ||C|| epsilon` root-reserve inequality
...
Let `C` be the complete bounded linear mismatch/collar/terminal/port
observation in this normalized finite-dimensional space. Put
