# L-14314 — Exact three-mode prolate source repair and Schwartzification
...
Equation (L-14314.7) follows by evaluating the compressed Fourier eigenvalue
equation at zero. Formula (L-14314.8) proves the two-mode obstruction.
...
Taking `delta` sufficiently small proves (L-14314.15). Finally, Fourier
...
4. Recompute (L-14314.13) from the full Fourier inner-product matrix.
...
6. Do not infer a Weil graph bound from (L-14314.16) alone.
