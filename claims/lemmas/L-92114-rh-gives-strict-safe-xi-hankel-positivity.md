# L-92114 — RH gives strict positivity of every finite safe-Xi barycentric Hankel pair
...
with dimensions interpreted as in `L-92112`.

This proves, a fortiori,
...
for every finite safe Xi packet.
...
Thus the same argument supplies directly the finite positive-string membership
of `L-92111`; the Hankel proof is not merely a formal matrix consequence.
