# L-24510 — Continuum dilation duality and Möbius uniqueness
...
The integrand in (L-24510.7) is nonnegative and has integral zero. Hence
...
everywhere, namely the smoothed Möbius profile (L-24510.11).

## 4. Consequence for parabolic reshaping

The one-parameter and polynomial perturbations of the parabolic seed can move
constraint excess between reciprocal cells, but they cannot produce a
non-arithmetic pointwise minorant with objective `4`. If a perturbation makes
the small-ratio excess strictly negative, equation (L-24510.7) forces positive
excess on another set unless the perturbation reconstructs the Möbius profile.

This explains both:

1. the positive fixed-ratio band certified in `X-24502`;
2. the failure of finite-dimensional continuum LP reshaping as a complete
   closure.

The remaining theorem must transport the signed excess or prove positivity of
the exact Möbius-saturated inverse. It cannot be replaced by a smooth universal
seed.

## Relation to Lagarias

The finite harmonic difference in (L-24510.4) is the same elementary cutoff
