...
where all terms are positive and source-disjoint,
...
Then (L-92900.5) gives \(r_X\ge0\), and substituting (L-92900.4)--(L-92900.6)
into (L-92900.3) yields the exact realized capacity identity
...
The equality and the positivity of \(r_X\) are both proved, but by distinct
facts:
