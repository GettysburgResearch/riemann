...
Claim ID: `T-105640`  
Status: **MAJOR UNCONDITIONAL SOURCE/LOCALIZATION ADVANCE; BOUNDARY-COLLAR INDEX OPEN**  
Created: 2026-08-25  
Depends on: `T-105620--T-105630`; `L-105640--L-105643`; `R-105640`  
RH status: **unproved**
...
strip below `beta_1`; it is the **microscopic top collar of the first
anti-inner Xi-prime factors**, together with its pointwise/index conversion.
...
The remaining collar statement is
...
BCOLLAR105643 boundary-collar index conversion          OPEN / RH-BEARING
...
The theorem gives a quantitative localization of the first anti-inner event.
It does not prove that the event cannot occur, does not identify a weighted
trace with unweighted degree, and does not prove RH. The strong-log-concavity
and innerness proofs are marked for independent hostile review before
integration.