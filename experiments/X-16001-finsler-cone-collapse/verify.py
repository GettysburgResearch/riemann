...
def main():
    ...
    print()
    print("Interpretation (see claims/refutations/R-16001):")
    print("  The finite gate of the working note is satisfiable for every strictly")
    print("  positive target and every special Q, while the finite Fourier transform")
    print("  of such a target need not have any real zero.  The gate therefore")
    print("  certifies the INTERPOLATION-POLYNOMIAL model, where positivity already")
    print("  forces real roots by a Nevanlinna argument, and not the FOURIER model")
    print("  that Theorem 3.1 needs.")
