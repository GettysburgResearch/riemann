...
`scan_extended.c` is the independent long-double Kahan scanner used for the retained 20,000,000-endpoint campaign. A secondary double scan reached 250,000,000. Numerical scans do not prove TAP4 or RH.
