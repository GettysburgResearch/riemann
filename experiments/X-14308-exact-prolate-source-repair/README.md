# X-14308 — exact prolate source and radical-tail regression

This directory implements the finite rational algebra used by `L-14314` and
`L-14315`. It is a synthetic checker, not a prolate-function evaluator and not
