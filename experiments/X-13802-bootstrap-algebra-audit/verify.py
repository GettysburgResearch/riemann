...
def hermite_x2_plus_1() -> dict[str, Any]:
    # Roots i and -i give q0=2, q1=0, q2=-2.
    h00 = Fraction(2)
    h01 = Fraction(0)
    h11 = Fraction(-2)
...
def targeted_li_first_coefficient() -> dict[str, Any]:
    # Exact synthetic logarithmic derivative F(alpha)=1+2i and u=1.
    u = Fraction(1)
    f_re = Fraction(1)
    f_im = Fraction(2)
...
def classical_li_modulus_constant() -> dict[str, Any]:
    # rho=1/2-delta+i gamma.  Algebraically:
    # |1-1/rho|^2 = |rho-1|^2/|rho|^2 = 1+2 delta/|rho|^2.
