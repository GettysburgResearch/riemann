#!/usr/bin/env python3
"""Exact verifier for L-14312/L-14313 synthetic controls.
...
def verify_radical(section: dict[str, Any]) -> dict[str, Any]:
    ...
    # Exact radical-tail transport on the localized coordinate basis.
    ...
    # In dimension two the ordinary annihilator of span{k} is generated by n=(-k1,k0).
