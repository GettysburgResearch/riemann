...
2. The claimed 22,801-unit frontier extension used a transposed/misplaced digit
   group in the imported published height and lies wholly below the actual
   frontier.
...
6. **Close-pair data are reusable, but not a necessary RH-failure precursor.**
