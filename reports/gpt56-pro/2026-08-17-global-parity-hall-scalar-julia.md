# Research report - adaptive parity-Hall scalar/Julia reduction

## Frozen genealogy

```text
base PR:      #561
base SHA:     db9bdc63c855c6ddf664b763d748f8155a6a2c67
comparison:   #559 single 5:3 scalar
comparison:   #556 annular reserve
comparison:   #562 bottom-contact Julia terminalization
```
...
```text
single-scalar collapse                  PROVED EXACT
adaptive homogeneous parity depth       PROVED
smooth interior                         PROVED NONNEGATIVE
parity-covariant Julia lift             PROVED EXACT
activation-boundary localization        PROVED EXACT
